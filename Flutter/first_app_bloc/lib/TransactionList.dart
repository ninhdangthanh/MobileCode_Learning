...
class TransactionList extends StatelessWidget {
  ...
  ListView _buildListView(MyBloc _myBloc, BuildContext context) {
          ...
          return Card(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                TextButton(
                  onPressed: () {
                    print("delete ${transactions[index].content}");
                    _myBloc.add(DeleteData(transaction: transactions[index]));
                  },
                  child: const Icon(
                    Icons.delete,
                    color: Colors.white,
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<MyBloc, MyBlocState>(builder: (context, state) {
      return Container(height: 500, child: _buildListView(_myBloc, context));
    });
  }
}
